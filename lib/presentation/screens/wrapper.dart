...
class Wrapper extends StatelessWidget {
  ...
  //     case WrapperScreenState.authentication:
  //       return BlocProvider<AuthenticationWrapperCubit>(
  //         create: (context) => AuthenticationWrapperCubit(),
  //         child: const AuthenticationWrapper(),
  //       );
  //     case WrapperScreenState.emailVerification:
